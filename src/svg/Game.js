...
const GameCanvas = (props) => {
  ...
  function database(answer) {
    console.log(
      "🚀 ~ file: Game.js ~ line 27 ~ database ~ lastCorrectAnswer",
      lastCorrectAnswer
    );
    console.log("🚀 ~ file: Game.js ~ line 27 ~ database ~ answer", answer);
    console.log("🚀 ~ database ~ primaryRN", primaryRN);
    console.log("🚀 ~ database ~ secondaryRN", secondaryRN);
    console.log("🚀 ~ database ~ tertiaryRN", tertiaryRN);
    ...
    console.log("🚀 ~ //setTimeout ~ jsonData question ", jsonData["question"]);
    console.log("🚀 ~ //setTimeout ~ lastQuestion", lastQuestion);
    ...
    let selectedAnswer =
      lastCorrectAnswer === answer
        ...
        : jsonData["selectedAnswer"] +
          ...
          `x,`;
    console.log(
      "🚀 ~ //setTimeout ~ lastCorrect",
      lastQuestion.slice((lastQuestion.length - 1, lastQuestion.length))
    );
    console.log(
      "🚀 ~ //setTimeout ~ lastCorrectAnswer",
      lastQuestion.slice(0, 1) + 1 + lastQuestion.slice(1)
    );
    console.log("🚀 ~ //setTimeout ~ lastCorrectAnswer", lastCorrectAnswer);
    console.log("🚀 ~ //setTimeout ~ correctAnswer", correctAnswer);
    console.log("🚀 ~ //setTimeout ~ newList[answer]", newList[answer]);
    console.log("🚀 ~ //setTimeout ~ selectedAnswer", selectedAnswer);
    ...
    console.log(
      "🚀 ~ file: Game.js ~ line 207 ~ //setTimeout ~ newItem",
      newItem
    );
    ...
    // }, 3000);
    console.log("🚀 ~ //setTimeout ~ correctAnswer", correctAnswer);
    console.log("🚀 ~ //setTimeout ~ primaryRN", primaryRN);
    console.log("🚀 ~ //setTimeout ~ secondaryRN", secondaryRN);
    console.log("🚀 ~ //setTimeout ~ tertiaryRN", tertiaryRN);
